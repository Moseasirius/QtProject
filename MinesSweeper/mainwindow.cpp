...
{
    QMessageBox::information(this,"about","version 1.0扫雷，是一款单人的电脑游戏。游戏目标是找出所有没有地雷的方格，完成游戏；"
                                          "要是按了有地雷的方格，游戏失败。游戏以完成时间来评高低。");

}

void MainWindow::on_actionInstructions_triggered()
{
     QMessageBox::information(this,"instructions","扫雷，是一款单人的电脑游戏。游戏目标是找出所有没有地雷的方格，完成游戏；"
                                                  "要是按了有地雷的方格，游戏失败。游戏以完成时间来评高低。");
}
